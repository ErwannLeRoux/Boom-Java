...
/**
 *Classe representant un combattant de type Gardian dans notre modele  de jeu
 ...
 * </ul>
 * 
 * Un Gardian est un combattant pour lequel on a augmenter l'energie.
 */
public class Gardian extends Fighter {
    /**
     * Constructeur créant une instance de Gardian en fonction de tous ses parametres.
    ...
    /**
     * Constructeur creant une instance de Gardian en fonction de son nom, sa couleur, ses parametre recuperé grace au parser de fichier et sa stratégie
     * 
     * @param pName son nom
     * @param pColor sa couleur
    ...
    /**
     * Constructeur creant une instance de Gardian en fonction de son nom, sa couleur et sa stratégie.
     * 
     * @param pName son nom
     * @param pColor sa couleur
     * @param strat sa strategie
